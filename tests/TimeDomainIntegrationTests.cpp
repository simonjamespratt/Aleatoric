...
{
    actlib::Numbers::Numbers numbersFactory;

    std::vector<int> sourceDurations {1, 2, 3, 4, 5};

    actlib::TimeDomain::Prescribed durationProtocol(sourceDurations);

    actlib::TimeDomain::Producer instance(
        durationProtocol,
...
SCENARIO("TimeDomain: Integration using Multiples and Cycle")
{
          ...
          "factor")
    {
        ...
        actlib::Numbers::Range range(11, 13);

        actlib::TimeDomain::Multiples durationProcotol(baseIncrement, range);
    ...
    GIVEN("The duration protocol is configured with a range a deviation factor")
    {
        ...
        actlib::TimeDomain::Multiples durationProtocol(
            baseIncrement,
            range,
            deviationFactor,
          ...
          "and no deviation factor")
    {
        ...
        actlib::TimeDomain::Multiples durationProtocol(baseIncrement,
                                                       multipliers);
...
SCENARIO("TimeDomain: Integration using Geometric and Cycle")
{
          ...
          "size")
    {
        ...
        actlib::TimeDomain::Geometric durationProtocol(range, collectionSize);
